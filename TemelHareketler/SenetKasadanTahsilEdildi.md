...
SayfaTipi: SenetKasadanTahsilEdildi
---

# Senet Kasadan Tahsil Edildi
...
Senet kasadan tahsil edildi, bir senedin ödemesinin kasasından alındığını ve senet karşılığında tahsilatın yapıldığını belirtir. 
Bu işlem, senedin bedelinin kasaya nakit veya başka bir ödeme şekliyle girdiği anlamına gelir.
...
- **Çek Senet Ekle:** Kasadan tahsil edilen senedi seçelim.
