---
SayfaID: CekSenetMusteriyeIadeAlindi
SayfaTipi: CekCariyeIadeEdildi
---

# Çek Müşteriye İade Edildi
...
- Sol menüden *ÇekSenet -> Hareket Oluştur -> Çek Müşteriye İade Edildi* şeklinde ulaşabilirsiniz. 
- Sol menüden *Müşteri/Satıcı -> Hareket Oluştur -> Çek -> Çek Müşteriye İade Edildi* şeklinde ulaşabilirsiniz. 

### Tanım 

Çek Müşteriye İade Edildi işlemi, bir müşteri tarafından teslim alınan çekin, belirli bir nedenle müşteriye geri verilmesi sürecini ifade eder. 
Bu durum, çekin hatalı düzenlenmesi, anlaşmanın iptali veya başka bir nedenle tahsil edilememesi gibi durumlarda gerçekleşebilir. 
İade edilen çek, muhasebe kayıtlarına işlenir ve ilgili hesaplardan düşülür. 
Bu işlem, çekin müşteri tarafından yeniden kullanılmasını veya başka bir şekilde değerlendirilmesini sağlar.
...
- **Çek Senet Ekle:** Müşteriye iade edilen çeki seçelim.
...
- Doldurulması gereken alanlar girildikten sonra sağ alt köşede bulunan *Kaydet* butonuna tıklayarak çek müşteriye iade edildi işleminizi tamamlayabilirsiniz.
