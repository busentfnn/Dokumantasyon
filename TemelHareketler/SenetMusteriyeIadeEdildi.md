---
SayfaID: CekSenetCariyeIadeEdildi
SayfaTipi: SenetCariyeIadeEdildi
---

# Senet Müşteriye İade Edildi 
...
[![Image](../TemelHareketler/senetmusteriyeiade.png)](TemelHareketler)

### Ulaşım

- Sol sekmede Aaro kullanıcı bilgilerinin hemen altında yer alan arama motorundan "senet" şeklinde aratarak ulaşabilirsiniz.
- Sol menüden *ÇekSenet -> Hareket Oluştur -> Senet -> Senet Müşteriye İade Edildi* şeklinde ulaşabilirsiniz. 

### Tanım 

Senet müşteriye iade edildi, daha önce bir müşteriden alınan senedin geri verildiğini belirtir. 
Bu işlem, senedin iptali, anlaşmazlık ya da başka bir nedenle müşteriye iade edilmesi durumunda gerçekleşir.
...
- **Çek Senet Ekle:** Cariye iade edilen senedi seçelim.
...
- Kopyala: Senet müşteriye iade edildi işlemini kopyalamak için kullanılır.
...
- Doldurulması gereken alanlar girildikten sonra sağ alt köşede bulunan *Kaydet* butonuna tıklayarak senet müşteriye iade edildi işleminizi tamamlayabilirsiniz.
