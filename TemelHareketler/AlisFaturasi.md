...
- Sol sekmede Aaro kullanıcı bilgilerinin hemen altındaki arama motorundan 'Alış' şeklinde aratarak ulaşabilirsiniz.
- Sol sekmede yer alan modüller kısmından *Musteri/Satici -> Hareket Oluştur -> Alış Faturası* şeklinde ulaşabilirsiniz.
- Sol sekmede yer alan modüller kısmından *Satın Alma -> Hareket Oluştur -> Alış Faturası* şeklinde ulaşabilirsiniz.
...
### Alış Faturası:
 ...
 Bir işletmenin tedarikçisinden satın aldığı mal veya hizmet için ödeme yapmayı taahhüt ettiği resmi belgedir. Alış faturası, işletmenin satın alma işlemlerini kayıt altına almak için kullanılır ve muhasebe kayıtlarında önemli bir rol oynar. Faturada aşağıdaki bilgiler bulunur:

- Tedarikçinin adı, adresi ve vergi kimlik numarası
- Alıcının bilgileri
...
- **Açıklama:** İşleme ait açıklamayı ve özel notları belirtir.
...
- **Cari Adres:** Carinin adresini belirtir. Kalemlerde değiştirilebilir.
...
- Miktar: Alış faturasında belirtilmesi istenilen stoğun miktarını belirtir, bu alanın doldurulması gerekmektedir.
...
- İskonto: Alış faturamızda kalem için iskonto oranını belirtir. Uyguladığımız bir iskonto var ise buraya oranı girebiliriz.
...
- Sağ üst köşede faturaya ait toplam fiyat kısımları bulunur;
	- Toplam: Alış faturamızın KDV hariç toplam tutarını içerir.
	- İskonto Sonrası: Alış faturamızın fiyatından uygulanan iskonto tutarını ifade eder.
	- Genel Toplam: Alış faturasının tüm kalemlerin tutarının toplamını belirtir.

- Kayıtlı bir kartı silmek için sol altta bulunan sil butonuna tıklayabilirsiniz.

## Kalem Ekleme

- Yeni Stok Kalemi Ekle: Alış faturasına stok kalemi eklemek için kullanılır.
- Yeni Gelirgider Kalemi Ekle: Alış faturasına gelir gider kalemi eklemek için kullanılır.
- Yeni Demirbaş Kalemi Ekle: Alış faturasına demirbaş kalemi eklemek için kullanılır.
...
- Doldurulması gereken alanlar girildikten sonra sağ alt köşede bulunan **Kaydet** butonuna tıklayarak alış faturası işleminizi tamamlayabilirsiniz.
- Kayıtlı bir kartı silmek için sol altta bulunan sil butonuna tıklayabilirsiniz.
...
Alış faturamızda ekleme yapmak ya da herhangi bir düzeltme yapmak için kalem işaretini seçerek açılan ekranda düzenleme yapabiliriz.
...
- Kopyala: Alış faturasını kopyalamak için kullanılır.
