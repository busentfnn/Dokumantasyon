...
- Sol menüden *ÇekSenet -> Hareket Oluştur -> Çek Ciro Edildi/Verildi* şeklinde ulaşabilirsiniz. 
- Sol menüden *Müşteri/Satıcı -> Hareket Oluştur -> Çek -> Çek Ciro Edildi/Verildi* şeklinde ulaşabilirsiniz. 

### Tanım 

Çek Ciro Edildi ve Verildi işlemi, bir çekin üzerine ciro edilerek (yani, arkasına gerekli imzalar atılarak) başka bir kişiye veya kuruma devredilmesi sürecini ifade eder. 
Bu işlem, çekin bir ödeme aracı olarak kullanılması veya bir borcun devredilmesi amacıyla gerçekleştirilir. 
Ciro edilen çek, yeni alıcı tarafından tahsil edilebilir veya başka birine devredilebilir. 
Muhasebe kayıtlarında, ciro edilen çekin verildiği kişi veya kurum belirtilir ve ilgili hesaplara işlenir.
...
- **Çek Senet Ekle:** Ciro işlemini gerçekleştireceğimiz çeki ekleyelim.

### Ciro Ekle 

- **Ciro Ekle:** Ciro işlemini gerçekleştireceğimiz çeki seçelim. 
...
- Çek-Senet Kopyala: Çeki kopyalamak için kullanılır.

## Kaydetme ve Silme

- Doldurulması gereken alanlar girildikten sonra sağ alt köşede bulunan *Kaydet* butonuna tıklayarak çek ciro edildi/verildi işleminizi tamamlayabilirsiniz.
