...
- Sol menüden *ÇekSenet -> Hareket Oluştur -> Senet Ciro Edildi/Verildi* şeklinde ulaşabilirsiniz. 
- Sol menüden *Müşteri/Satıcı -> Hareket Oluştur -> Senet -> Senet Ciro Edildi/Verildi* şeklinde ulaşabilirsiniz. 
...
- Doldurulması gereken alanlar girildikten sonra sağ alt köşede bulunan *Kaydet* butonuna tıklayarak senet ciro edildi/verildi işleminizi tamamlayabilirsiniz.
